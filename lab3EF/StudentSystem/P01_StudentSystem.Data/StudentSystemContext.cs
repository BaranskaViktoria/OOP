...
namespace P01_StudentSystem.Data
{
    public class StudentSystemContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=WIN-HGKNVQ9J21J;Initial Catalog=StudentSystem;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;");
        }
