...
namespace BeautySalon.API.Controllers
{
    ...
    public class MasterController : ControllerBase
    {
        ...
        //GET: api/events
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Master>>> GetAllEventsAsync()
        {
            try
            {
        ...
        //GET: api/servise/Id
        [HttpGet("{id}")]
        public async Task<ActionResult<Master>> GetByIdAsync(int id)
        {
            try
            {
        ...
        //POST: api/events
        [HttpPost]
        public async Task<ActionResult> PostEventAsync([FromBody] Master evnt)
        {
            try
            {
                if (evnt == null)
                ...
                var created_id = await _ADOuow._masterRepository.AddAsync(evnt);
                _ADOuow.Commit();
        ...
        //POST: api/events/id
        [HttpPut("{id}")]
        public async Task<ActionResult> UpdateEventAsync(int id, [FromBody] Master evnt)
        {
            try
            {
                if (evnt == null)
                ...
                await _ADOuow._masterRepository.ReplaceAsync(evnt);
                _ADOuow.Commit();
